...
import com.example.android.mygarden.provider.*;
...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager,
                                          int imgRes,long plantsId,boolean showWater, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            updateAppWidget(context,  appWidgetManager, imgRes,plantsId, showWater, appWidgetId);
        }
    }
